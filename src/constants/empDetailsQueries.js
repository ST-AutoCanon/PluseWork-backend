module.exports = {
  ...
  ADD_EMPLOYEE_PERSONAL: `
    ...
    alternate_email, alternate_number, blood_group, emergency_contact_person,
...
SELECT
  ...
  -- professional
  pr.sub_org_id, pr.employee_type,
...
`,
  ...
  LEFT JOIN sub_orgs so
    ON pr.sub_org_id = so.id
...
`,
  ...
  GET_SUPERVISOR_ASSIGNMENT_RULE: `
  SELECT rank_mode, above_rank_count, department_scope
  FROM supervisor_assignment_settings
  WHERE org_id = ?
    AND (department_id = ? OR department_id IS NULL)
    AND is_active = 1

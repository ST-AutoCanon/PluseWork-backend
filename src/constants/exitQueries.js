...
//   WHERE org_id = ?
//     AND status IN ('APPLIED', 'WITHDRAW_REQUESTED')
//     AND is_active = 1
...
//   FROM employee_exit_requests
//   WHERE org_id = ?
//     AND status IN ('MANAGER_APPROVED', 'WITHDRAW_APPROVED')
//     AND is_active = 1
...
//   WHERE employee_id = ?
//     AND org_id = ?
//     AND status IN ('APPLIED', 'MANAGER_APPROVED')
//     AND is_active = 1
// `,

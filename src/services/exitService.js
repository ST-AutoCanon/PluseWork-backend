...
// const EXIT_QUERIES = require("../constants/exitQueries");

// /* ========================= EMPLOYEE APPLY EXIT ========================= */
// const applyExit = async ({ employeeId, orgId, reason, otherReason, proposedLwd, comments }) => {
//   if (!employeeId || !orgId || !reason || !proposedLwd) {
//     throw new Error("Missing required fields");
//   }

//   const pool = await getTenantPoolByOrgId(orgId);

//   await pool.execute(EXIT_QUERIES.APPLY_EXIT, [
//     orgId,
//     employeeId,
//     reason,
//     otherReason || null,
...
// /* ========================= MANAGER ========================= */
// const getManagerExitList = async ({ orgId }) => {
//   if (!orgId) throw new Error("Org ID is required");

//   const pool = await getTenantPoolByOrgId(orgId);
//   const [rows] = await pool.execute(EXIT_QUERIES.GET_MANAGER_EXITS, [orgId]);

//   return rows;
// };
// const managerAction = async ({ exitId, status, managerRecommendedLwd, comments, orgId }) => {
//   if (!exitId || !status || !orgId) throw new Error("Missing required fields");
...
//       lwd = managerRecommendedLwd;
//       break;

//     case "MANAGER_REJECTED":
//       finalStatus = "MANAGER_REJECTED";
//       isActive = 0;
//       break;

//     case "WITHDRAW_APPROVED": // withdrawal approved by manager → HR
//       finalStatus = "WITHDRAW_APPROVED";
//       break;

//     case "WITHDRAW_REJECTED":
//       finalStatus = "WITHDRAW_REJECTED";
//       isActive = 0;
//       break;
...
//   await pool.execute(EXIT_QUERIES.MANAGER_ACTION, [
//     finalStatus,
//     comments || null,
//     lwd,
//     isActive,
...
//   return { message: "Manager action saved" };
// };


// /* ========================= HR ========================= */
// const getHRExitList = async ({ orgId }) => {
//   if (!orgId) throw new Error("Org ID is required");

//   const pool = await getTenantPoolByOrgId(orgId);
//   const [rows] = await pool.execute(EXIT_QUERIES.GET_HR_EXITS, [orgId]);

//   return rows;
// };

// const hrAction = async ({ exitId, status, hrFinalLwd, comments, orgId }) => {
//   if (!exitId || !status || !orgId) {
//     throw new Error("Missing required fields");
//   }
...
//     default:
//       throw new Error("Invalid HR action status");
//   }

//   await pool.execute(EXIT_QUERIES.HR_ACTION, [
//     finalStatus,
//     comments || null,
//     lwd,
//     isActive,
...
//   return { message: "HR action saved" };
// };

// /* ========================= WITHDRAW EXIT ========================= */
// const withdrawExit = async ({ employeeId, orgId, reason }) => {
//   if (!employeeId || !orgId || !reason) {
//     throw new Error("Missing required fields");
//   }
...
//     EXIT_QUERIES.WITHDRAW_EXIT,
//     [reason, employeeId, orgId]
//   );

//   if (result.affectedRows === 0) {
//     throw new Error("No active resignation found to withdraw");
//   }
